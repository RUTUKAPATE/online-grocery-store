...
function ProductItemDetail({product}) {
  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 p-7 bg-white text-black'>
        <Image src={process.env.NEXT_PUBLIC_BACKEND_BASE_URL+product.images[0].url} alt='image' width={300} height={300} className='bg-slate-200 p-5 h-[320px] w-[300px] object-contain rounded-lg'/>
        <div className='flex flex-col gap-3'>
            ...
            <div className='flex flex-col items-baseline gap-3'>
                <div className='flex gap-3 items-center'>
                    ...
                    <h2 className='text-2xl font-bold'> = ${(quantity*productTotalPrice).toFixed}</h2>
                </div>
