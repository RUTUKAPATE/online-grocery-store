  ...
  return (
    <div className='flex gap-5 mt-2 overflow-auto mx-7 md:mx-20 justify-center'>
      {categoryList.map((category, index) => (
        <Link href={'/products-category/' + category.name} className={`flex flex-col items-center bg-green-50 gap-2 p-3 rounded-lg group hover:bg-green-600 w-[150px] min-w-[100px] ${selectedCategory==category.name&&'bg-green-600 text-white'}`}>
